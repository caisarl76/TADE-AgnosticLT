...
def get_dataset(data, dataset, imb_ratio, transform_train=None, val_transform=None):
    if dataset == 'cub':
        num_classes = 200
        head_class_idx = [0, 72]
        ...
        train_dataset = Aircraft(root=data, imb_type='exp', imb_factor=imb_ratio, train=True, download=True, transform=transform_train)
        val_dataset = Aircraft(root=data, imb_type='exp', imb_factor=imb_ratio, train=False, download=True, transform=val_transform)
        ...
        train_dataset = Dogs(root=data, imb_type='exp', imb_factor=imb_ratio, train=True, download=True, transform=transform_train)
        val_dataset = Dogs(root=data, imb_type='exp', imb_factor=imb_ratio, train=False, download=True, transform=val_transform)
        ...
        train_dataset = Cars(root=data, imb_type='exp', imb_factor=imb_ratio, train=True, download=True, transform=transform_train)
        new_class_idx = train_dataset.get_new_class_idx_sorted()
        val_dataset = Cars(root=data, imb_type='exp', imb_factor=imb_ratio, train=False, download=True, transform=val_transform, new_class_idx_sorted=new_class_idx)
        ...
        train_dataset = Flowers(root=data, imb_type='exp', imb_factor=imb_ratio, train=True, download=True, transform=transform_train)
        val_dataset = Flowers(root=data, imb_type='exp', imb_factor=imb_ratio, train=False, download=True, transform=val_transform)
        ...
        train_dataset = DTD(root=data, imb_type='exp', imb_factor=imb_ratio, train=True, download=True, transform=transform_train)
        val_dataset = DTD(root=data, imb_type='exp', imb_factor=imb_ratio, train=False, download=True, transform=val_transform)
